  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8 pb-12">
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-zinc-500 dark:text-zinc-400">Update existing journal announcement info.</p>
          </div>
        </div>
        ...
        <form action={deleteAnnouncement.bind(null, id)}>
          <button
            type="submit"
            className="p-3 text-red-500 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-xl transition-colors border border-transparent hover:border-red-200"
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-sm overflow-hidden">
        <form action={updateAnnouncement.bind(null, id)} className="p-8 space-y-6">
